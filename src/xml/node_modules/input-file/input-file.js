(function ($) {
    ...
    var isIE = function (ver) {
        ...
        tPreview = '<div class="file-preview {class}">\n' +
            ...
            '    </div>\n' +
            '</div>',
        tIcon = '<span class="fa fa-caret-right" style="margin-right:5px;"></span>',
        tCaption = '<div style="height:34px;border-radius:0px;border:1px solid #D6D6D6;" tabindex="-1" class="form-control file-caption {class}">\n' +
            '   <span class="file-caption-ellipsis">&hellip;</span>\n' +
            '   <div style="margin:8px 10px 0px;font-size:12px;" class="file-caption-name"></div>\n' +
            '</div>',
        ...
        tImage = '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}">\n' +
            ...
            '   {footer}\n' +
            '</div>\n',
        tText = '<div class="file-preview-frame{frameClass}" style="display:contents;" id="{previewId}" data-fileindex="{fileindex}">\n' +
            '   <div class="file-preview-text" style="margin:auto;margin-top:15px;margin-bottom:15px;" title="{caption}" ' + STYLE_SETTING + '>\n' +
            '       {data}\n' +
            '   </div>\n' +
            '   {footer}\n' +
            '</div>',
        ...
        defaultPreviewSettings = {
            ...
            /*
            Modificaciones para subir archivos de video y audio
            */
    ...
    FileInput.prototype = {
        ...
        showUploadError: function (msg, data, previewId, index, ev) {
            ...
            if ($error.find('ul').length === 0) {
                ...
                $error.html('<p style="text-align:left;">' + msg + '</p>');
            } else {
        ...
        renderBrowse: function () {
            ...
            return '<div style="height:34px;border-radius:0px;padding:7px 10px;" class="' + css + '"' + status + '> ' + self.browseIcon + self.browseLabel + ' </div>';
        },
        renderRemove: function () {
            ...
            return '<button style="height:34px;border-radius:0px;padding:7px 10px;border:1px solid #d6d6d6;" type="button" title="' + self.removeTitle + '" class="' + css + '"' + status + '>' + self.removeIcon + self.removeLabel + '</button>';
        },
    ...
    $.fn.fileinput.defaults = {
        ...
        browseLabel: '<span style="font-weight:400;">Buscar</span>',
        browseIcon: '<i class="fa fa-search" style="font-size:14px;"></i> &nbsp;',
        browseClass: 'btn btn-primary',
        removeLabel: '<span>Remover</span>',
        ...
        msgFilesTooMany: 'No. de archivos permitidos excedido en: <b>{n}</b></br>Solo puedes cargar: <b>{m}</b> archivo(s)',
        ...
        msgInvalidFileExtension: 'Extension invalida de archivo <strong>{name}</strong>. Solo <strong>{extensions}</strong> son soportadas.',
        msgValidationError: '<span class="text-danger"><i class="fa fa-exclamation-circle"></i>Archivo No Permitido</span>',
        ...
        dropZoneTitle: '<span style="font-size:13px;">Seleccione un archivo &hellip;</span>',
